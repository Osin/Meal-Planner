...
const privacyAndConfidentiality = () => {
  return (
      <NextAppDirEmotionCacheProvider options={{key: 'css'}}>
        <ThemeProvider theme={theme}>
          ...
          <Box>
            <Typography variant={'h2'}>A. Introduction</Typography>
            <ol>
            ...
            <Typography variant={'h2'}>B. Source</Typography>
            Ce document a été créé grâce à un modèle de SEQ Legal (seqlegal.com)
            et a été modifié par Website Planet (<a href="https://www.websiteplanet.com">www.websiteplanet.com</a>)<p></p>
            <Typography variant={'h2'}>C. Collecte d’informations personnelles </Typography>
            <p>  Les types d’informations personnelles suivants peuvent collectés, stockés et utilisés à travers les publicités de Google Ad Sense, les images récupérées via Unsplash et les informations d'urls que vous partagiez en utilisant le partage d'url.</p>
            <ol>
            ...
            Avant de nous divulguer des informations personnelles concernant une autre personne, vous devez obtenir le consentement de ladite personne en ce qui concerne la divulgation et le traitement de ces informations personnelles selon les termes de cette politique<p></p>
            <Typography variant={'h2'}>D. Utilisation de vos informations personnelles</Typography><p></p>
            Les informations personnelles qui nous sont fournies par le biais de notre site web seront utilisées dans les objectifs décrits dans cette politique ou dans les pages du site pertinentes. Nous pouvons utiliser vos informations personnelles pour:<p></p>
            <ol>
            ...
            Si vous soumettez des informations personnelles sur notre site web dans le but de les publier, nous les publierons et pourrons utiliser ces informations conformément aux autorisations que vous nous accordez.<p></p>
            Vos paramètres de confidentialité peuvent être utilisés pour limiter la publication de vos informations sur notre site web et peuvent être ajustés dans vos paramètres de confidentialité sur le site web.<p></p>
            Sans votre consentement explicite, nous ne fournirons pas vos informations personnelles à des tierces parties pour leur marketing direct, ni celui d’autres tierces parties.<p></p>
            <Typography variant={'h2'}>E. Divulgation de vos informations personnelles</Typography><p></p>
            Nous pouvons divulguer vos informations personnelles à n’importe lequel de nos employés, dirigeants, assureurs, conseillers professionnels, agents, fournisseurs, ou sous-traitants dans la mesure où cela est raisonnablement nécessaire aux fins énoncées dans cette politique.<p></p>
            Nous pouvons divulguer vos informations personnelles à n’importe quel membre de notre groupe d’entreprises (cela signifie nos filiales, notre société holding ultime et toutes ses filiales) dans la mesure où cela est raisonnablement nécessaire aux fins énoncées dans cette politique.<p></p>
            Nous pouvons divulguer vos informations personnelles:<p></p>
            <ol>
            ...
            Sauf disposition contraire de la présente politique, nous ne transmettrons pas vos informations personnelles à des tierces parties.<p></p>
            <Typography variant={'h2'}>F. Transferts internationaux de données </Typography>
            <ol>
            ...
            <Typography variant={'h2'}>G. Conservation de vos informations personnelles</Typography><p></p>
            <ol>
              <li>Cette Section G détaille nos politiques de conservation des données et nos procédures, conçues pour nous aider à nous conformer à nos obligations légales concernant la conservation et la suppression d’informations personnelles.</li>
              ...
              <li>Nonobstant les autres dispositions de cette Section G, nous conserverons des documents (y compris des documents électroniques) contenant des données personnelles:
                <ol type="a">
                  <li>Dans la mesure où nous sommes tenus de le faire par la loi ;</li>
            ...
            <Typography variant={'h2'}>H. Sécurité de vos informations personnelles</Typography><p></p>
            <ol>
            ...
            <Typography variant={'h2'}>I. Amendements</Typography><p></p>
            Nous pouvons parfois mettre cette politique à jour en publiant une nouvelle version sur notre site web. Vous devez vérifier cette page régulièrement pour vous assurer de prendre connaissance de tout changement effectué à cette politique. Nous pouvons vous informer des changements effectués à cette politique par courrier électronique ou par le biais du service de messagerie privée de notre site web.<p></p>
            <Typography variant={'h2'}>J. Vos droits</Typography><p></p>
            Vous pouvez nous demander de vous fournir toute information personnelle que nous détenons sur vous ; le transfert de telles informations sera soumis aux conditions suivantes:<p></p>
            <ol>
              <li>Le règlement de frais de 30€ lié au temps de recherche et récupération de ses informations; et</li>
              <li>La présentation de preuves suffisantes de votre identité, un email devrait suffire</li>
            </ol>
            Nous pouvons retenir les informations personnelles que vous demandez dans la mesure autorisée par la loi.<p></p>
            Vous pouvez nous demander à tout moment de ne pas traiter vos informations personnelles à des fins marketing.<p></p>
            En pratique, vous exprimerez expressément et à l’avance votre accord pour que nous utilisions vos informations personnelles à des fins marketing ou nous vous fournirons une opportunité de refuser l’utilisation de vos informations personnelles à des fins marketing.<p></p>
            <Typography variant={'h2'}>K. Sites web tiers</Typography><p></p>
            Notre site web contient des liens hypertextes menant vers des sites web tiers et des informations les concernant. Nous n’avons aucun contrôle sur ces sites, et ne sommes pas responsables de leurs politiques de confidentialité ni de leurs pratiques.<p></p>
            ...
            <ol>
              <li>Les noms des cookies que nous utilisons sur notre site web et les objectifs dans lesquels nous les utilisons sont décrits ci-dessous:
                <ol type="a">
                  <li>Nous utilisons Google Analytics et Adwords sur notre site web pour reconnaître un ordinateur lorsqu’un utilisateur consulte le site web/ suivre les utilisateurs lors de leur navigation sur le site web/ activer l’utilisation d’un panier sur le site web/ améliorer l’utilisation d’un site web/ analyser l’utilisation du site web/ administrer le site web/ empêcher la fraude et améliorer la sécurité du site web/ personnaliser le site web pour chaque utilisateur/ envoyer des publicités ciblées pouvant intéresser certains utilisateurs</li>
                  <li>Nous utilisons Unsplash pour récupérer des photos des saisies de plats que vous réalisez</li>
                </ol>
              </li>
            ...
            Bloquer tous les cookies aura un impact négatif sur l’utilisation de nombreux sites web. Si vous bloquez les cookies, vous ne pourrez pas utiliser toutes les fonctionnalités de notre site web.<p></p>
            <ol>
              <li>Vous pouvez supprimer les cookies déjà stockés sur votre ordinateur. Exemple:
                <ol type="a">
                  <li>avec Internet Explorer (version 10), vous devez supprimer le fichier cookies manuellement (vous pourrez trouver des instructions pour le faire ici <a href="http://support.microsoft.com/kb/278835">http://support.microsoft.com/kb/278835</a>);</li>
...
export default privacyAndConfidentiality;